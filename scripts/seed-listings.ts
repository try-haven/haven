...
// Fake listings data - 85 diverse apartments across 3 states (25 CA, 22 NY, 21 TX)
const fakeListings = [
  {
    id: "1",
  ...
  // Additional California listings (43-45)
  {
    id: "43",
    title: "Sacramento Downtown Loft",
    address: "1010 J St, Sacramento, CA 95814",
    price: 1800,
    bedrooms: 1,
    bathrooms: 1,
    sqft: 750,
    ...
    amenities: ["Gym", "Bike storage", "Parking", "AC"],
    description: "Modern loft in state capital. Walk to Capitol building and light rail.",
    available_from: "2025-02-01",
  },
  {
    id: "44",
    title: "Fresno Family Home",
    address: "2345 N Palm Ave, Fresno, CA 93704",
    price: 1600,
    bedrooms: 3,
    bathrooms: 2,
    sqft: 1400,
    ...
    amenities: ["Backyard", "In-unit laundry", "Parking", "AC", "Pet-friendly"],
    description: "Spacious home in Central Valley. Near shopping and schools.",
    available_from: "2025-01-15",
  },
  {
    id: "45",
    title: "Long Beach Coastal Studio",
    address: "456 E Ocean Blvd, Long Beach, CA 90802",
    price: 1900,
    bedrooms: 0,
    bathrooms: 1,
    sqft: 500,
    ...
    amenities: ["Ocean views", "Pool", "Gym", "Parking"],
    description: "Beachfront studio with stunning ocean views. Walk to waterfront and Aquarium.",
    available_from: "2025-03-01",
  },
  // New York listings (46-65) - 20 total
  {
    id: "46",
    ...
    amenities: ["Hardwood floors", "Fireplace", "Dishwasher", "Near subway"],
    description: "Classic Brooklyn Heights brownstone with Manhattan skyline views.",
    available_from: "2025-02-01",
  },
  {
    id: "47",
    ...
    amenities: ["Exposed brick", "High ceilings", "Rooftop access", "Gym"],
    description: "Trendy Williamsburg loft near Bedford L train. Walk to restaurants and nightlife.",
    available_from: "2025-01-20",
  },
  {
    id: "48",
    title: "Upper West Side Classic 6",
    address: "345 W 72nd St, New York, NY 10023",
    price: 4500,
    bedrooms: 3,
    bathrooms: 2,
    sqft: 1600,
    ...
    amenities: ["Doorman", "Elevator", "Laundry room", "Near Central Park"],
    description: "Pre-war elegance on Upper West Side. Steps from Central Park and subway.",
    available_from: "2025-02-15",
  },
  {
    id: "49",
    title: "Astoria Garden Apartment",
    address: "456 31st Ave, Astoria, NY 11106",
    price: 2100,
    bedrooms: 1,
    bathrooms: 1,
    sqft: 700,
    ...
    amenities: ["Garden access", "Dishwasher", "Near N/W trains", "Pet-friendly"],
    description: "Quiet Astoria apartment with garden. Near Greek restaurants and Steinway Street.",
    available_from: "2025-01-10",
  },
  {
    id: "50",
    title: "Chelsea High-Rise Studio",
    ...
    amenities: ["Doorman", "Gym", "Rooftop deck", "Package room"],
    description: "Modern Chelsea studio with Hudson Yards views. Walk to High Line and galleries.",
    available_from: "2025-03-01",
  },
  {
    id: "51",
    title: "Park Slope 2BR",
    address: "678 7th Ave, Brooklyn, NY 11215",
    price: 3100,
    bedrooms: 2,
    bathrooms: 1,
    sqft: 1000,
    ...
    amenities: ["Hardwood floors", "Dishwasher", "Near Prospect Park", "F/G trains"],
    description: "Charming Park Slope apartment near Prospect Park. Family-friendly neighborhood.",
    available_from: "2025-02-20",
  },
  {
    id: "52",
    title: "Lower East Side Walk-Up",
    address: "789 Delancey St, New York, NY 10002",
    price: 2400,
    bedrooms: 1,
    bathrooms: 1,
    sqft: 650,
    ...
    amenities: ["Exposed brick", "Updated kitchen", "Near J/M/Z trains"],
    description: "Classic LES character with modern updates. Heart of nightlife and culture.",
    available_from: "2025-01-15",
  },
  {
    id: "53",
    title: "Harlem Renovated 1BR",
    address: "890 Lenox Ave, New York, NY 10026",
    price: 2000,
    bedrooms: 1,
    bathrooms: 1,
    sqft: 750,
    ...
    amenities: ["Dishwasher", "In-unit laundry", "Near 2/3 trains", "Hardwood floors"],
    description: "Newly renovated Harlem apartment. Near restaurants and Central Park.",
    available_from: "2025-03-10",
  },
  {
    id: "54",
    title: "Greenwich Village Charmer",
    address: "234 Bleecker St, New York, NY 10012",
    price: 3800,
    bedrooms: 2,
    bathrooms: 1,
    sqft: 950,
    ...
    amenities: ["Fireplace", "Bay windows", "Hardwood floors", "Near A/C/E trains"],
    description: "Quintessential Village apartment on historic Bleecker Street. Walk to Washington Square Park.",
    available_from: "2025-02-05",
  },
  {
    id: "55",
    title: "Long Island City View",
    address: "345 44th Dr, Long Island City, NY 11101",
    price: 2600,
    bedrooms: 1,
    bathrooms: 1,
    sqft: 800,
    ...
    amenities: ["Manhattan views", "Gym", "Pool", "Concierge", "Near 7 train"],
    description: "Modern LIC apartment with stunning Manhattan skyline views. One stop to Midtown.",
    available_from: "2025-01-25",
  },
  {
    id: "56",
    ...
    amenities: ["High ceilings", "Exposed brick", "Cast iron columns", "Near C/E trains"],
    description: "Iconic SoHo loft in heart of shopping district. Gallery space meets residential luxury.",
    available_from: "2025-03-15",
  },
  {
    id: "57",
    title: "Bushwick Artist Loft",
    address: "567 Troutman St, Brooklyn, NY 11237",
    price: 1900,
    bedrooms: 2,
    bathrooms: 1,
    sqft: 1000,
    ...
    amenities: ["High ceilings", "Skylights", "Bike storage", "Near L train"],
    description: "Creative space in vibrant Bushwick. Near galleries, bars, and Maria Hernandez Park.",
    available_from: "2025-02-10",
  },
  {
    id: "58",
    title: "Financial District High-Rise",
    address: "678 Wall St, New York, NY 10005",
    price: 3500,
    bedrooms: 2,
    bathrooms: 2,
    sqft: 1200,
    ...
    amenities: ["Harbor views", "Doorman", "Gym", "Pool", "Concierge"],
    description: "Luxury FiDi living with water views. Walk to Battery Park and subway hub.",
    available_from: "2025-01-20",
  },
  {
    id: "59",
    title: "Tribeca Warehouse Conversion",
    address: "789 Franklin St, New York, NY 10013",
    price: 5000,
    bedrooms: 2,
    bathrooms: 2.5,
    sqft: 1500,
    ...
    amenities: ["High ceilings", "Chef's kitchen", "Washer/dryer", "Parking"],
    description: "Stunning Tribeca conversion with industrial charm. Near Hudson River Park.",
    available_from: "2025-03-05",
  },
  {
    id: "60",
    title: "Crown Heights Garden Level",
    address: "890 Eastern Pkwy, Brooklyn, NY 11213",
    price: 1800,
    bedrooms: 1,
    bathrooms: 1,
    sqft: 700,
    ...
    amenities: ["Garden access", "Hardwood floors", "Near 2/3/4 trains", "Pet-friendly"],
    description: "Peaceful Crown Heights garden apartment. Near Brooklyn Museum and Prospect Park.",
    available_from: "2025-02-15",
  },
  {
    id: "61",
    title: "Midtown East Junior 1BR",
    address: "234 E 45th St, New York, NY 10017",
    price: 2800,
    bedrooms: 0,
    bathrooms: 1,
    sqft: 600,
    ...
    amenities: ["Doorman", "Elevator", "Laundry room", "Near Grand Central"],
    description: "Convenient Midtown location. Steps from Grand Central and restaurants.",
    available_from: "2025-01-10",
  },
  {
    id: "62",
    title: "Kips Bay Renovated 2BR",
    address: "345 E 28th St, New York, NY 10016",
    price: 3300,
    bedrooms: 2,
    bathrooms: 1.5,
    sqft: 1100,
    ...
    amenities: ["Updated kitchen", "Dishwasher", "Elevator", "Near 6 train"],
    description: "Fully renovated Kips Bay apartment. Near NYU Medical Center and restaurants.",
    available_from: "2025-02-28",
  },
  {
    id: "63",
    title: "Gramercy Park Adjacent",
    address: "456 E 20th St, New York, NY 10003",
    price: 3600,
    bedrooms: 1,
    bathrooms: 1,
    sqft: 850,
    ...
    amenities: ["Pre-war charm", "Doorman", "Elevator", "Near park"],
    description: "Elegant Gramercy living near the exclusive park. Quiet residential enclave.",
    available_from: "2025-03-20",
  },
  {
    id: "64",
    title: "Battery Park City Family Home",
    address: "567 South End Ave, New York, NY 10280",
    price: 4800,
    bedrooms: 3,
    bathrooms: 2,
    sqft: 1600,
    ...
    amenities: ["River views", "Doorman", "Gym", "Pool", "Playground"],
    description: "Family-friendly Battery Park City. Near waterfront parks and excellent schools.",
    available_from: "2025-01-15",
  },
  {
    id: "65",
    title: "Murray Hill Classic Studio",
    address: "678 3rd Ave, New York, NY 10016",
    price: 2200,
    bedrooms: 0,
    bathrooms: 1,
    sqft: 500,
    ...
    amenities: ["Doorman", "Laundry room", "Near 6 train", "Roof deck"],
    description: "Cozy Murray Hill studio in well-maintained building. Near Grand Central.",
    available_from: "2025-02-12",
  },
  // Texas listings (66-85) - 20 total
  {
    id: "66",
    title: "Houston Heights Bungalow",
    ...
    amenities: ["Hardwood floors", "Backyard", "Parking", "AC", "Pet-friendly"],
    description: "Charming Heights bungalow with character. Walk to restaurants and shops.",
    available_from: "2025-02-01",
  },
  {
    id: "67",
    title: "Dallas Uptown High-Rise",
    address: "2345 McKinney Ave, Dallas, TX 75201",
    price: 2200,
    bedrooms: 1,
    bathrooms: 1,
    sqft: 800,
    ...
    amenities: ["Pool", "Gym", "Concierge", "Parking", "Skyline views"],
    description: "Modern Uptown Dallas living. Walk to restaurants, bars, and DART.",
    available_from: "2025-01-20",
  },
  {
    id: "68",
    title: "San Antonio River Walk Condo",
    address: "3456 S Alamo St, San Antonio, TX 78205",
    price: 1600,
    bedrooms: 1,
    bathrooms: 1,
    sqft: 700,
    ...
    amenities: ["River views", "Pool", "Gym", "AC", "Parking"],
    description: "Steps from River Walk. Downtown location near Alamo and restaurants.",
    available_from: "2025-02-15",
  },
  {
    id: "69",
    title: "Fort Worth Cultural District Loft",
    ...
    amenities: ["High ceilings", "Exposed brick", "AC", "Parking", "Bike storage"],
    description: "Artistic loft near museums and galleries. Walk to Kimbell Art Museum.",
    available_from: "2025-01-10",
  },
  {
    id: "70",
    title: "Austin South Congress Studio",
    address: "5678 S Congress Ave, Austin, TX 78704",
    price: 1900,
    bedrooms: 0,
    bathrooms: 1,
    sqft: 550,
    ...
    amenities: ["Pool", "Gym", "AC", "Bike storage", "Pet-friendly"],
    description: "Hip SoCo location. Walk to food trucks, boutiques, and Lady Bird Lake.",
    available_from: "2025-03-01",
  },
  {
    id: "71",
    title: "Houston Montrose 2BR",
    address: "6789 Westheimer Rd, Houston, TX 77006",
    price: 2000,
    bedrooms: 2,
    bathrooms: 1.5,
    sqft: 1000,
    ...
    amenities: ["Updated kitchen", "Parking", "AC", "Dishwasher", "Near restaurants"],
    description: "Trendy Montrose neighborhood. Near Museum District and nightlife.",
    available_from: "2025-02-20",
  },
  {
    id: "72",
    title: "Dallas Bishop Arts Loft",
    address: "7890 W Davis St, Dallas, TX 75208",
    price: 1800,
    bedrooms: 1,
    bathrooms: 1,
    sqft: 800,
    ...
    amenities: ["High ceilings", "Exposed brick", "AC", "Parking", "Walk to galleries"],
    description: "Artistic Bishop Arts District. Walk to galleries, theaters, and restaurants.",
    available_from: "2025-01-15",
  },
  {
    id: "73",
    title: "Austin East Side Bungalow",
    address: "8901 E 6th St, Austin, TX 78702",
    price: 2100,
    bedrooms: 2,
    bathrooms: 1,
    sqft: 900,
    ...
    amenities: ["Backyard", "Parking", "AC", "Hardwood floors", "Pet-friendly"],
    description: "Cool East Side bungalow. Walk to bars, coffee shops, and downtown.",
    available_from: "2025-03-10",
  },
  {
    id: "74",
    title: "Houston Midtown Modern",
    address: "9012 Main St, Houston, TX 77002",
    price: 1900,
    bedrooms: 1,
    bathrooms: 1,
    sqft: 750,
    ...
    amenities: ["Pool", "Gym", "AC", "Parking", "Near Metro Rail"],
    description: "Modern Midtown living. Walk to restaurants, bars, and light rail.",
    available_from: "2025-02-05",
  },
  {
    id: "75",
    title: "Dallas Knox-Henderson Apartment",
    address: "1023 N Henderson Ave, Dallas, TX 75206",
    price: 2000,
    bedrooms: 1,
    bathrooms: 1,
    sqft: 800,
    ...
    amenities: ["Updated kitchen", "AC", "Parking", "Near restaurants", "Dishwasher"],
    description: "Trendy Knox-Henderson location. Walk to restaurants, bars, and shopping.",
    available_from: "2025-01-25",
  },
  {
    id: "76",
    title: "San Antonio Alamo Heights Home",
    address: "2134 Broadway, San Antonio, TX 78209",
    price: 2200,
    bedrooms: 3,
    bathrooms: 2,
    sqft: 1400,
    ...
    amenities: ["Backyard", "Parking", "AC", "In-unit laundry", "Near shops"],
    description: "Family-friendly Alamo Heights. Near shopping and excellent schools.",
    available_from: "2025-03-15",
  },
  {
    id: "77",
    title: "Austin Zilker Park Cottage",
    address: "3245 Barton Springs Rd, Austin, TX 78704",
    price: 2300,
    bedrooms: 2,
    bathrooms: 1,
    sqft: 900,
    ...
    amenities: ["Near park", "Parking", "AC", "Backyard", "Pet-friendly"],
    description: "Steps from Zilker Park and Barton Springs Pool. Quintessential Austin living.",
    available_from: "2025-02-10",
  },
  {
    id: "78",
    title: "Houston Rice Village Studio",
    address: "4356 Rice Blvd, Houston, TX 77005",
    price: 1500,
    bedrooms: 0,
    bathrooms: 1,
    sqft: 500,
    ...
    amenities: ["Pool", "AC", "Parking", "Near shops", "Gym"],
    description: "Convenient Rice Village location. Walk to restaurants, shops, and Rice University.",
    available_from: "2025-01-20",
  },
  {
    id: "79",
    title: "Dallas Deep Ellum Warehouse",
    address: "5467 Elm St, Dallas, TX 75226",
    price: 1900,
    bedrooms: 1,
    bathrooms: 1,
    sqft: 850,
    ...
    amenities: ["High ceilings", "Exposed brick", "AC", "Parking", "Near venues"],
    description: "Deep Ellum warehouse conversion. Heart of Dallas music and nightlife scene.",
    available_from: "2025-03-05",
  },
  {
    id: "80",
    title: "Austin University Area 2BR",
    address: "6578 Guadalupe St, Austin, TX 78705",
    price: 1700,
    bedrooms: 2,
    bathrooms: 1,
    sqft: 900,
    ...
    amenities: ["AC", "Parking", "Near UT", "Dishwasher", "Bike storage"],
    description: "Near UT Austin campus. Walk to Drag restaurants and shops.",
    available_from: "2025-02-15",
  },
  {
    id: "81",
    title: "Houston Galleria Area High-Rise",
    address: "7689 Westheimer Rd, Houston, TX 77063",
    price: 2400,
    bedrooms: 2,
    bathrooms: 2,
    sqft: 1100,
    ...
    amenities: ["Pool", "Gym", "Concierge", "Parking", "City views"],
    description: "Luxury Galleria living. Steps from high-end shopping and restaurants.",
    available_from: "2025-01-10",
  },
  {
    id: "82",
    title: "Dallas Lakewood Cottage",
    address: "8790 Abrams Rd, Dallas, TX 75214",
    price: 1600,
    bedrooms: 2,
    bathrooms: 1,
    sqft: 850,
    ...
    amenities: ["Backyard", "Parking", "AC", "Hardwood floors", "Pet-friendly"],
    description: "Quiet Lakewood neighborhood. Near White Rock Lake and trails.",
    available_from: "2025-02-28",
  },
  {
    id: "83",
    title: "Austin Clarksville Historic Home",
    address: "9801 W 10th St, Austin, TX 78703",
    price: 2500,
    bedrooms: 2,
    bathrooms: 1.5,
    sqft: 1000,
    ...
    amenities: ["Historic charm", "Parking", "AC", "Backyard", "Near downtown"],
    description: "Historic Clarksville cottage. Walk to downtown and Lake Austin.",
    available_from: "2025-03-20",
  },
  {
    id: "84",
    title: "Houston EaDo Loft",
    address: "1912 Leeland St, Houston, TX 77003",
    price: 1800,
    bedrooms: 1,
    bathrooms: 1,
    sqft: 800,
    ...
    amenities: ["High ceilings", "AC", "Parking", "Near stadiums", "Bike storage"],
    description: "Hip EaDo warehouse loft. Near Minute Maid Park and breweries.",
    available_from: "2025-01-15",
  },
  {
    id: "85",
    title: "Dallas Lower Greenville Apartment",
    address: "2023 Greenville Ave, Dallas, TX 75206",
    price: 1700,
    bedrooms: 1,
    bathrooms: 1,
    sqft: 750,
    ...
    amenities: ["AC", "Parking", "Dishwasher", "Near bars", "Updated kitchen"],
    description: "Lower Greenville neighborhood. Walk to restaurants, bars, and nightlife.",
    available_from: "2025-02-12",
  },
];
...
async function seedDatabase() {
  ...
  try {
    ...
    console.log(`✓ Inserted ${fakeListings.length} listings (25 CA, 22 NY, 21 TX)`);
